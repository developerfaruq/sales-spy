  ...
  <body>
    <div class="flex h-screen bg-gray-50">
        ...
        <div class="flex flex-col h-full">
          ...
          <nav class="flex-1 overflow-y-auto py-4">
            <ul>
              ...
              <li class="mb-2">
                <a
                  href="../frontend/Dashboard-ecc.html"
                  class="flex items-center px-4 py-3 text-gray-600 hover:bg-gray-100 rounded-r-lg hover:text-primary transition-colors"
                >
                  <div class="w-6 h-6 flex items-center justify-center mr-3">
      ...
      >
        ...
        <main class="flex-1 p-6">
          <div class="mb-6">
           <h1 class="text-2xl font-bold text-primary mb-2" style="color: #1E3A8A;">Websites</h1>
            <p class="text-gray-600">
              Search, filter, and discover <span class="font-bold " style="color: #1E3A8A;">Websites leads</span> for your business.
            </p>
          </div>
          <!-- Filters Section -->
            ...
            <div class="p-4">
              ...
              <div id="advancedFilters" class="hidden">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
                  ...
                  <!-- Removed: Product Count, Collections Count, Product Avg Price, Currency, Installed Apps -->
                </div>
              </div>
              <div class="flex mt-6">
                <button
            ...
            <div class="overflow-x-auto">
              <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                  <!-- Example row, repeat for each result row -->
                  <tr class="hover:bg-gray-50 result-row cursor-pointer"
                      data-domain="yamloveme.com"
                      data-platform="Shopify"
                      data-title="yamloveme"
                      data-description="Trendy jewelry and accessories"
                      data-language="EN"
                      data-country="US"
                      data-email="contact@yamloveme.com"
                      data-phone="+1 555-5678"
                      data-tags="Jewelry,Trendy,US"
                      data-domainregdate="2019-04-12"
                      data-indexeddate="2024-06-01"
                  >
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      contact@yamloveme.com
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      +1 555-5678
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <span class="bg-blue-100 text-blue-800 text-xs px-3 py-1 rounded-full mr-1">Jewelry</span>
                      <span class="bg-blue-100 text-blue-800 text-xs px-3 py-1 rounded-full mr-1">Trendy</span>
                      <span class="bg-blue-100 text-blue-800 text-xs px-3 py-1 rounded-full">US</span>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      2019-04-12
                    </td>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <a href="#">facebook.com/yamloveme</a>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <a href="#">twitter.com/yamloveme</a>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <a href="#">instagram.com/yamloveme</a>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <a href="#">pinterest.com/yamloveme</a>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <a href="#">tiktok.com/@yamloveme</a>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <a href="#">youtube.com/yamloveme</a>
                    </td>
                  </tr>
                  <tr class="hover:bg-gray-50 result-row cursor-pointer"
                      data-domain="true-compress.com"
                      data-platform="Shopify"
                      data-title="True Compress"
                      data-description="Compression wear for athletes"
                      data-country="GB"
                      data-language="EN"
                      data-email="support@true-compress.com"
                      data-phone="+44 20 1234 5678"
                      data-tags="Athletic,Compression,GB"
                      data-domainregdate="2021-08-22"
                      data-indexeddate="2024-06-01"
                  >
                    <td class="px-6 py-4 whitespace-nowrap">
                      <div class="flex items-center">
                        <div
                          class="w-8 h-8 flex items-center justify-center bg-blue-100 rounded-full mr-3"
                        >
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      support@true-compress.com
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      +44 20 1234 5678
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <span class="bg-blue-100 text-blue-800 text-xs px-3 py-1 rounded-full mr-1">Athletic</span>
                      <span class="bg-blue-100 text-blue-800 text-xs px-3 py-1 rounded-full mr-1">Compression</span>
                      <span class="bg-blue-100 text-blue-800 text-xs px-3 py-1 rounded-full">GB</span>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      2021-08-22
                    </td>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <a href="#">facebook.com/truecompress</a>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <a href="#">twitter.com/truecompress</a>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <a href="#">instagram.com/truecompress</a>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <a href="#">pinterest.com/truecompress</a>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <a href="#">tiktok.com/@truecompress</a>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <a href="#">youtube.com/truecompress</a>
                    </td>
                  </tr>
                  <tr class="hover:bg-gray-50 result-row cursor-pointer"
                      data-domain="www.telenaarl.com"
                      data-platform="Shopify"
                      data-title="TeleNaarl – Timeless Jewellery for Every Occasion"
                      data-description="Fine jewelry for all occasions"
                      data-country="IN"
                      data-language="EN"
                      data-email="hello@telenaarl.com"
                      data-phone="+91 22 1234 5678"
                      data-tags="Jewelry,Timeless,IN"
                      data-domainregdate="2018-11-10"
                      data-indexeddate="2024-06-01"
                  >
                    <td class="px-6 py-4 whitespace-nowrap">
                      <div class="flex items-center">
                        <div
                          class="w-8 h-8 flex items-center justify-center bg-purple-100 rounded-full mr-3"
                        >
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      TeleNaarl – Timeless Jewellery for Every Occasion
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <span class="bg-blue-100 text-blue-800 text-xs px-3 py-1 rounded-full mr-1">Jewelry</span>
                      <span class="bg-blue-100 text-blue-800 text-xs px-3 py-1 rounded-full mr-1">Timeless</span>
                      <span class="bg-blue-100 text-blue-800 text-xs px-3 py-1 rounded-full">IN</span>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      2018-11-10
                    </td>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <a href="#">facebook.com/telenaarl</a>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <a href="#">twitter.com/telenaarl</a>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <a href="#">instagram.com/telenaarl</a>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <a href="#">pinterest.com/telenaarl</a>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <a href="#">tiktok.com/@telenaarl</a>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <a href="#">youtube.com/telenaarl</a>
                    </td>
                  </tr>
                  <tr class="hover:bg-gray-50 result-row cursor-pointer"
                      data-domain="dbfay.com"
                      data-platform="Shopify"
                      data-title="dbfay"
                      data-description="Fashion and accessories"
                      data-country="FR"
                      data-language="FR"
                      data-email="contact@dbfay.com"
                      data-phone="+33 1 23 45 67 89"
                      data-tags="Fashion,Accessories,FR"
                      data-domainregdate="2020-02-18"
                      data-indexeddate="2024-06-01"
                  >
                    <td class="px-6 py-4 whitespace-nowrap">
                      <div class="flex items-center">
                        <div
                          class="w-8 h-8 flex items-center justify-center bg-green-100 rounded-full mr-3"
                        >
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <span class="bg-blue-100 text-blue-800 text-xs px-3 py-1 rounded-full mr-1">Fashion</span>
                      <span class="bg-blue-100 text-blue-800 text-xs px-3 py-1 rounded-full mr-1">Accessories</span>
                      <span class="bg-blue-100 text-blue-800 text-xs px-3 py-1 rounded-full">FR</span>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      2020-02-18
                    </td>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <a href="#">facebook.com/dbfay</a>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <a href="#">twitter.com/dbfay</a>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <a href="#">instagram.com/dbfay</a>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <a href="#">pinterest.com/dbfay</a>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <a href="#">tiktok.com/@dbfay</a>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <a href="#">youtube.com/dbfay</a>
                    </td>
                  </tr>
                  <tr class="hover:bg-gray-50 result-row cursor-pointer"
                      data-domain="epicfalls.legendary-laughs.shop"
                      data-platform="Shopify"
                      data-title="Epic Falls: Legendary Laughs!"
                      data-description="Humor gifts and novelties"
                      data-country="US"
                      data-language="EN"
                      data-email=""
                      data-phone="+1 555-9876"
                      data-tags="Humor,Gifts,US"
                      data-domainregdate="2022-01-05"
                      data-indexeddate="2024-06-01"
                  >
                    <td class="px-6 py-4 whitespace-nowrap">
                      <div class="flex items-center">
                        <div
                          class="w-8 h-8 flex items-center justify-center bg-yellow-100 rounded-full mr-3"
                        >
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      Epic Falls: Legendary Laughs!
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      Humor gifts and novelties
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      EN
                    </td>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <span class="bg-blue-100 text-blue-800 text-xs px-3 py-1 rounded-full mr-1">Humor</span>
                      <span class="bg-blue-100 text-blue-800 text-xs px-3 py-1 rounded-full mr-1">Gifts</span>
                      <span class="bg-blue-100 text-blue-800 text-xs px-3 py-1 rounded-full">US</span>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      2022-01-05
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <a href="#">facebook.com/epicfalls</a>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <a href="#">twitter.com/epicfalls</a>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <a href="#">instagram.com/epicfalls</a>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <a href="#">pinterest.com/epicfalls</a>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <a href="#">tiktok.com/@epicfalls</a>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <a href="#">youtube.com/epicfalls</a>
                    </td>
                  </tr>
                  <tr class="hover:bg-gray-50 result-row cursor-pointer"
                      data-domain="akitada.com"
                      data-platform="Shopify"
                      data-title="akitada"
                      data-description="Japanese home goods"
                      data-country="DE"
                      data-language="DE"
                      data-email="kontakt@akitada.com"
                      data-phone="+49 30 123456"
                      data-tags="Home Goods,Japanese,DE"
                      data-domainregdate="2017-07-30"
                      data-indexeddate="2024-06-01"
                  >
                    <td class="px-6 py-4 whitespace-nowrap">
                      <div class="flex items-center">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <span class="bg-blue-100 text-blue-800 text-xs px-3 py-1 rounded-full mr-1">Home Goods</span>
                      <span class="bg-blue-100 text-blue-800 text-xs px-3 py-1 rounded-full mr-1">Japanese</span>
                      <span class="bg-blue-100 text-blue-800 text-xs px-3 py-1 rounded-full">DE</span>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      2017-07-30
                    </td>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <a href="#">facebook.com/akitada</a>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <a href="#">twitter.com/akitada</a>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <a href="#">instagram.com/akitada</a>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <a href="#">pinterest.com/akitada</a>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <a href="#">tiktok.com/@akitada</a>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      data-domainregdate="2016-03-14"
                      data-indexeddate="2024-06-01"
                  >
                    <td class="px-6 py-4 whitespace-nowrap">
                      <div class="flex items-center">
                        <div
                          class="w-8 h-8 flex items-center justify-center bg-pink-100 rounded-full mr-3"
                        >
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <span class="bg-blue-100 text-blue-800 text-xs px-3 py-1 rounded-full mr-1">Beauty</span>
                      <span class="bg-blue-100 text-blue-800 text-xs px-3 py-1 rounded-full mr-1">Professional</span>
                      <span class="bg-blue-100 text-blue-800 text-xs px-3 py-1 rounded-full">ID</span>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      2016-03-14
                    </td>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <a href="#">facebook.com/avapros</a>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <a href="#">twitter.com/avapros</a>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <a href="#">instagram.com/avapros</a>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <a href="#">pinterest.com/avapros</a>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <a href="#">tiktok.com/@avapros</a>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <a href="#">youtube.com/avapros</a>
                    </td>
                  </tr>
                  <tr class="hover:bg-gray-50 result-row cursor-pointer"
                      data-domain="blackrow.com"
                      data-platform="Shopify"
                      data-title="blackrow"
                      data-description="Streetwear and urban fashion"
                      data-country="VN"
                      data-language="VI"
                      data-email="hello@blackrow.com"
                      data-phone="+84 28 1234 5678"
                      data-tags="Streetwear,Urban,VN"
                      data-domainregdate="2015-12-01"
                      data-indexeddate="2024-06-01"
                  >
                    <td class="px-6 py-4 whitespace-nowrap">
                      <div class="flex items-center">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <span class="bg-blue-100 text-blue-800 text-xs px-3 py-1 rounded-full mr-1">Streetwear</span>
                      <span class="bg-blue-100 text-blue-800 text-xs px-3 py-1 rounded-full mr-1">Urban</span>
                      <span class="bg-blue-100 text-blue-800 text-xs px-3 py-1 rounded-full">VN</span>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      2015-12-01
                    </td>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <a href="#">facebook.com/blackrow</a>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <a href="#">twitter.com/blackrow</a>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <a href="#">instagram.com/blackrow</a>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <a href="#">pinterest.com/blackrow</a>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <a href="#">tiktok.com/@blackrow</a>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <a href="#">youtube.com/blackrow</a>
                    </td>
                  </tr>
                  <tr class="hover:bg-gray-50 result-row cursor-pointer"
                      data-domain="foxness.com"
                      data-platform="Shopify"
                      data-title="foxness"
                      data-description="Pet accessories and toys"
                      data-country="NL"
                      data-language="NL"
                      data-email="info@foxness.com"
                      data-phone="+31 20 1234567"
                      data-tags="Pets,Accessories,NL"
                      data-domainregdate="2023-02-14"
                      data-indexeddate="2024-06-01"
                  >
                    <td class="px-6 py-4 whitespace-nowrap">
                      <div class="flex items-center">
                        <div
                          class="w-8 h-8 flex items-center justify-center bg-orange-100 rounded-full mr-3"
                        >
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <span class="bg-blue-100 text-blue-800 text-xs px-3 py-1 rounded-full mr-1">Pets</span>
                      <span class="bg-blue-100 text-blue-800 text-xs px-3 py-1 rounded-full mr-1">Accessories</span>
                      <span class="bg-blue-100 text-blue-800 text-xs px-3 py-1 rounded-full">NL</span>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      2023-02-14
                    </td>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <a href="#">facebook.com/foxness</a>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <a href="#">twitter.com/foxness</a>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <a href="#">instagram.com/foxness</a>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <a href="#">pinterest.com/foxness</a>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <a href="#">tiktok.com/@foxness</a>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <a href="#">youtube.com/foxness</a>
                    </td>
                  </tr>
                  <tr class="hover:bg-gray-50 result-row cursor-pointer"
                      data-domain="cofuze.com"
                      data-platform="Shopify"
                      data-title="cofuze.com - CoFuze™"
                      data-description="Coffee accessories and mugs"
                      data-country="IN"
                      data-language="EN"
                      data-email="support@cofuze.com"
                      data-phone="+91 44 1234 5678"
                      data-tags="Coffee,Accessories,IN"
                      data-domainregdate="2022-10-10"
                      data-indexeddate="2024-06-01"
                  >
                    <td class="px-6 py-4 whitespace-nowrap">
                      <div class="flex items-center">
                        <div
                          class="w-8 h-8 flex items-center justify-center bg-teal-100 rounded-full mr-3"
                        >
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <span class="bg-blue-100 text-blue-800 text-xs px-3 py-1 rounded-full mr-1">Coffee</span>
                      <span class="bg-blue-100 text-blue-800 text-xs px-3 py-1 rounded-full mr-1">Accessories</span>
                      <span class="bg-blue-100 text-blue-800 text-xs px-3 py-1 rounded-full">IN</span>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
            ...
            >
              <div class="flex items-center">
                <p class="text-sm text-gray-700">
                  ...
                  <span class="font-medium">317,455</span> results
                </p>
              </div>
              <div class="flex items-center space-x-2">
                <button
                  class="bg-primary text-white w-8 h-8 rounded flex items-center justify-center"
                >
                  <span>1</span>
                </button>
                <button
                  class="text-gray-500 hover:bg-gray-100 w-8 h-8 rounded flex items-center justify-center"
                >
                  <span>2</span>
                </button>
                <button
    ...
    <script>
      ...
      document.addEventListener("DOMContentLoaded", function () {
        ...
        // Only website-related columns for the Display dropdown
        const columns = [
        ...
        // Map table columns by header text (case-insensitive)
    ...
    <script>
      ...
      document.addEventListener("DOMContentLoaded", function () {
        ...
        // Helper: render only website-related fields from the full data object
...
<div class="p-4 md:p-8">
  <div class="bg-white rounded-lg shadow-md p-4 md:p-6 mb-6">
    ...
    <!-- Include the dashboard API integration script -->
    <script src="js/dashboard-com.js"></script>
  </body>
</html>