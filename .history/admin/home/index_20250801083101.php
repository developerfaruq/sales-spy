...
=======
              ...
              <span class="ml-2 text-sm font-medium hidden md:block"
                ><?= $adminName ?></span
              >
>>>>>>> 600c54b20a84a607ad161b11838593ef8f07abba:admin/home/index.php
...
>>>>>>> 600c54b20a84a607ad161b11838593ef8f07abba:admin/home/index.php
    ...
    <main class="pt-16 md:pl-64 transition-all duration-300">
        ...
        <div class="bg-white rounded-lg shadow-sm overflow-hidden">
          ...
          <div class="px-4 py-3 flex items-center justify-between border-t">
            ...
            <div class="flex items-center space-x-1" id="users-pagination">
              ...
              <button class="pagination-item text-gray-600 hover:bg-gray-100 users-page-btn" data-page="1">
                1
              </button>
              <button class="pagination-item text-gray-600 hover:bg-gray-100 users-page-btn" data-page="2">
                2
              </button>
              <button class="pagination-item text-gray-600 hover:bg-gray-100 users-page-btn" data-page="3">
                3
              </button>
              <button class="pagination-item text-gray-600 hover:bg-gray-100 users-page-btn" data-page="4">
                4
              </button>
              <button class="pagination-item text-gray-600 hover:bg-gray-100 users-page-btn" data-page="5">
                5
              </button>
      ...
      <div id="unsuspend-user-modal" class="modal">
        <div class="modal-content">
          ...
          <div class="space-y-4">
            ...
            <div>
              <label for="unsuspend-reason" class="block text-sm font-medium text-gray-700 mb-1">Reason for unsuspension
                (optional)</label>
      ...
      <!-- Subscriptions Tab -->
      <div id="subscriptions-tab" class="tab-content hidden p-4 md:p-6">
        <div class="mb-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          <div class="bg-white rounded-lg shadow-sm p-4">
            <div class="flex items-center">
              <div class="w-12 h-12 rounded-full bg-blue-100 text-primary flex items-center justify-center">
        ...
        <div class="bg-white rounded-lg shadow-sm overflow-hidden">
          ...
          <div class="overflow-x-auto">
            <table class="w-full">
              ...
              <tbody class="divide-y divide-gray-200" id="subscriptions-table-body">
                <!-- Filled by JS -->
              </tbody>
            </table>
          </div>
          <div class="px-4 py-3 flex items-center justify-between border-t">
            <div class="flex items-center text-sm text-gray-500">
              <span>Showing</span>
              <div class="custom-select mx-2" id="subscription-page-size-select">
                <div class="custom-select-trigger">
                  <span>10</span>
                  <i class="ri-arrow-down-s-line ml-1"></i>
                </div>
            ...
            <div class="flex items-center space-x-1" id="subscriptions-pagination">
              <button class="pagination-item text-gray-500 hover:bg-gray-100" id="subscriptions-prev-page">
                <i class="ri-arrow-left-s-line"></i>
              </button>
              <!-- Page numbers will be injected here -->
              <button class="pagination-item text-gray-600 hover:bg-gray-100 subscriptions-page-btn" data-page="1">
                1
              </button>
              <button class="pagination-item text-gray-600 hover:bg-gray-100 subscriptions-page-btn" data-page="2">
                2
              </button>
              <button class="pagination-item text-gray-600 hover:bg-gray-100 subscriptions-page-btn" data-page="3">
                3
              </button>
              <button class="pagination-item text-gray-600 hover:bg-gray-100 subscriptions-page-btn" data-page="4">
                4
              </button>
              <button class="pagination-item text-gray-600 hover:bg-gray-100 subscriptions-page-btn" data-page="5">
                5
              </button>
              <button class="pagination-item text-gray-500 hover:bg-gray-100" id="subscriptions-next-page">
                <i class="ri-arrow-right-s-line"></i>
              </button>
            </div>
          </div>
      ...
      <script>
        (function () {
          ...
          const subsPrevBtn = document.getElementById(
            "subscriptions-prev-page"
          );
          const subsNextBtn = document.getElementById(
            "subscriptions-next-page"
          );
        ...
        <tr>
            ...
            <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-600">${user.start
                  }</td>
            <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-600">${user.end
                  }</td>
            <td class="px-4 py-3 whitespace-nowrap">
              ...
              document
                ...
                .forEach((button) => {
                  ...
                  button.onmouseenter = function (e) {
                    const tooltip =
                      document.querySelector("body > .fixed.px-2");
                    if (tooltip) {
      ...
      <!-- Wallets Tab -->
      <div id="wallets-tab" class="tab-content hidden p-4 md:p-6">
        <div class="mb-6">
          <h1 class="text-2xl font-semibold text-gray-800">
            Wallet Management
          </h1>
        ...
        <div class="bg-white rounded-lg shadow-sm p-4 sm:p-6 mb-6">
          ...
          <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div class="lg:col-span-2">
              <div class="space-y-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    <label for="token-standard" class="block text-sm font-medium text-gray-700 mb-1">Token
                      Standard</label>
                ...
                <div>
                  ...
                  <div class="relative">
                    <input type="text" id="wallet-address"
                      ...
                      value="TVTkZq3ghDZgF8txTdDM3s8g76XM2pgiey" readonly />
                    <div class="absolute right-2 top-1/2 transform -translate-y-1/2 flex items-center space-x-2">
                      <button class="text-gray-400 hover:text-primary" id="copy-address">
            ...
            <div class="flex flex-col items-center justify-center p-4 sm:p-6 border border-gray-200 rounded-lg">
              <div id="qrcode" class="w-48 h-48 bg-white rounded-lg flex items-center justify-center mb-4"></div>
      ...
      <div id="payments-tab" class="tab-content hidden p-4 md:p-6">
        <div class="mb-6">
          <h1 class="text-2xl font-semibold text-gray-800">
        ...
        <div class="bg-white rounded-lg shadow-sm overflow-hidden">
          ...
          <div class="px-4 py-3 flex items-center justify-between border-t">
            ...
            <div class="flex items-center space-x-1" id="transactions-pagination">
              <button class="pagination-item text-gray-500 hover:bg-gray-100" id="transactions-prev-page">
                <i class="ri-arrow-left-s-line"></i>
              </button>
              <!-- Page numbers will be injected here -->
              <button class="pagination-item text-gray-600 hover:bg-gray-100 transactions-page-btn" data-page="1">
                1
              </button>
              <button class="pagination-item text-gray-600 hover:bg-gray-100 transactions-page-btn" data-page="2">
                2
              </button>
              <button class="pagination-item text-gray-600 hover:bg-gray-100 transactions-page-btn" data-page="3">
                3
              </button>
              <button class="pagination-item text-gray-600 hover:bg-gray-100 transactions-page-btn" data-page="4">
                4
              </button>
              <button class="pagination-item text-gray-600 hover:bg-gray-100 transactions-page-btn" data-page="5">
                5
              </button>
              <button class="pagination-item text-gray-500 hover:bg-gray-100" id="transactions-next-page">
                <i class="ri-arrow-right-s-line"></i>
              </button>
            </div>
          </div>
      ...
      <script>
        ...
        <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-600">${tx.orderId
                  }</td>
        <td class="px-4 py-3 whitespace-nowrap">
          <div class="flex items-center">
        <div class="w-8 h-8 rounded-full ${tx.user.color
                  } flex items-center justify-center">
        ...
        <td class="px-4 py-3 whitespace-nowrap">
          <span class="px-2 py-1 text-xs font-medium ${planColors[tx.plan] || "bg-gray-100 text-gray-600"
                  } rounded-full">${tx.plan}</span>
        </td>
        <td class="px-4 py-3 whitespace-nowrap text-sm font-medium text-gray-800">${tx.amount
                  } USDT</td>
        <td class="px-4 py-3 whitespace-nowrap">
          <a href="https://tronscan.org/#/transaction/${tx.txid
        ...
        <td class="px-4 py-3 whitespace-nowrap">
          <span class="px-2 py-1 text-xs font-medium rounded-full ${tx.status === "Success"
          ...
          document.getElementById("export-transactions-btn").onclick =
            function () {
              ...
              filteredTransactions.forEach((tx) => {
                csv += `"${tx.orderId}","${tx.user.name}","${tx.plan}","${tx.amount
                  }","${tx.txid}","${new Date(tx.date).toLocaleString()}","${tx.status
                  }"\n`;
              });
              const blob = new Blob([csv], { type: "text/csv" });
              const a = document.createElement("a");
        ...
        <span class="text-sm font-medium">${tx.user.initials}</span>
          ...
          <span class="ml-3 text-sm font-medium text-gray-800">${tx.user.name
              }</span>
        </div>
          </div>
          <div>
        ...
        <a href="https://tronscan.org/#/transaction/${tx.txid
              }" target="_blank" class="text-primary underline break-all text-xs">${tx.txid
              }</a>
          </div>
          <div>
...
<!-- Pending Payments -->
      <div id="pending-tab" class="tab-content hidden p-4 md:p-6">
        <div class="mb-6">
  ...
  <div id="toastContainer" class="fixed top-4 right-4 z-50 space-y-2"></div>
    ...
    <!-- Settings Tab -->
    <div id="settings-tab" class="tab-content hidden p-4 md:p-6">
      <div class="mb-6">
          ...
          <div class="bg-white rounded-lg shadow-sm p-6">
            ...
            <div class="space-y-4">
              ...
              <div>
                ...
                <div class="flex items-center">
                  <div class="w-8 h-8 rounded-lg bg-gray-100 flex items-center justify-center mr-4">
                    <img src="https://res.cloudinary.com/dtrn8j0sz/image/upload/v1749075914/SS_s4jkfw.jpg" alt="Logo" />
                  </div>
                  <div>
                    <button
        ...
        <div class="space-y-6">
          <div class="bg-white rounded-lg shadow-sm p-6">
            ...
            <div class="space-y-4">
              ...
              <div>
                <label for="session-timeout" class="block text-sm font-medium text-gray-700 mb-1">Admin Session Timeout
                  (minutes)</label>
    ...
    <script id="navigation-script">
      // Sidebar and tab navigation functionality
      document.addEventListener("DOMContentLoaded", function () {
        ...
        function activateTab(tabId) {
          navLinks.forEach((link) => {
            if (link.getAttribute("data-tab") === tabId) {
              ...
              link.classList.remove("text-primary", "bg-blue-50");
              link.classList.add(
                "text-gray-600",
                "hover:text-primary",
                "hover:bg-blue-50"
        ...
        customSelects.forEach((select) => {
          ...
          optionItems.forEach((option) => {
            option.addEventListener("click", function () {
              ...
              // For subscription plan select which has spans with classes
              if (select.classList.contains("subscription-plan-select")) {
                const optionHtml = this.innerHTML;
                trigger.querySelector("span").outerHTML = optionHtml;
              } else {
      ...
      <div class="modal-content max-w-2xl">
        ...
        <div class="space-y-4">
          <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
            ...
            <span class="px-2 py-1 text-xs font-medium bg-green-50 text-green-600 rounded-full">Active</span>
          </div>
          <div class="space-y-3">
            <div class="border-l-2 border-primary pl-3">
              <p class="text-sm font-medium text-gray-800">
    ...
    <div id="pause-subscription-modal" class="modal">
      <div class="modal-content">
        ...
        <div class="space-y-4">
          ...
          <div>
            <label for="pause-reason" class="block text-sm font-medium text-gray-700 mb-1">Reason for pausing
              (optional)</label>
            <textarea id="pause-reason" rows="3"
              class="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary"
              placeholder="Enter reason for pausing..."></textarea>
          </div>
          <div>
            <label for="pause-duration" class="block text-sm font-medium text-gray-700 mb-1">Pause Duration</label>
    ...
    <div id="cancel-subscription-modal" class="modal">
      <div class="modal-content">
        ...
        <div class="space-y-4">
          ...
          <div>
            <label for="cancel-reason" class="block text-sm font-medium text-gray-700 mb-1">Reason for cancellation
              (optional)</label>
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        let subscriptionChart, planDistributionChart;
        ...
        function initCharts() {
          ...
          if (
            ...
            subscriptionChart = echarts.init(
              document.getElementById("subscription-chart")
            );
          ...
          if (
            ...
            planDistributionChart = echarts.init(
              document.getElementById("plan-distribution-chart")
            );
            planDistributionChart.setOption({
              animation: false,
              tooltip: {
                trigger: "item",
                backgroundColor: "rgba(255,255,255,0.8)",
          ...
          // Always resize in case container size changed
          if (subscriptionChart) subscriptionChart.resize();
          if (planDistributionChart) planDistributionChart.resize();
        }

        // Listen for tab switch to subscriptions
        document
          .querySelectorAll('.nav-link[data-tab="subscriptions"]')
          .forEach((btn) => {
            btn.addEventListener("click", function () {
              setTimeout(initCharts, 100); // Wait for tab to become visible
            });
          });
        ...
        // If already visible on load, initialize
        if (
          !document
            .getElementById("subscriptions-tab")
