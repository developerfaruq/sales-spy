...
<div id="sidebar" class="sidebar-expanded bg-white shadow-lg z-20 flex flex-col transition-all duration-700 ease-in-out">
  ...
  <nav class="flex-1 overflow-y-auto py-4">
    <ul>
      ...
      <li class="mb-2">
        <a href="../webs/" class="flex items-center px-4 py-3 text-gray-600 hover:bg-gray-100 rounded-r-lg hover:text-primary transition-colors">
          <div class="w-6 h-6 flex items-center justify-center mr-3 sidebar-icon">
      ...
      <li class="mb-2">
        <a href="../ecommerce/" class="flex items-center px-4 py-3 text-gray-600 hover:bg-gray-100 rounded-r-lg hover:text-primary transition-colors">
          <div class="w-6 h-6 flex items-center justify-center mr-3 sidebar-icon">
