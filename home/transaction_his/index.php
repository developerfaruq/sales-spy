...
<html lang="en">
  ...
  <body>
    <div class="flex h-screen bg-gray-50">
          ...
          <div id="upgrade-section" class="p-4 border-t">
            ...
            >
              ...
              <div class="flex items-center justify-between">
                <span class="font-semibold text-lg sidebar-text">1,250</span>
                <span class="text-xs text-gray-500 sidebar-text">of 2,000</span>
              </div>
          ...
          <div class="max-w-7xl mx-auto">
            ...
            <div class="mb-6">
              ...
              <p class="text-gray-600">
                ...
                <span class="font-bold" style="color: #1e3a8a"
                  >transactions</span
                >, including payment details, statuses, and receipts.
              </p>
            </div>
            <!-- Filter Controls -->
            <div
              class="glassmorphism rounded-2xl p-6 mb-6 shadow-lg bg-white/95"
            ...
            >
              ...
              <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div class="relative">
                  ...
                  <div class="p-2">
                    <div
                    class="px-3 py-2 hover:bg-gray-100 rounded cursor-pointer text-gray-800"
                    data-value=""
                    >
                    All Types
                    </div>
            ...
            <script>
              // Transaction data as array for scalability
              const transactions = [
              {
                id: "TXN-2024-001847",
                date: "Dec 28, 2024",
              ...
              },
              {
                ...
                amount: 45.0,
                status: "Failed",
                orderId: "ORD-2024-5805",
                paymentId: "ETH-5729-8463-2947",
                description: "Basic Plan Subscription",
                walletAddress: "0x742d35Cc6634C0532925a3b8D0c5AA1234567890",
              },
              {
                id: "TXN-2024-001792",
                date: "Dec 18, 2024",
                ...
                amount: 79.99,
                status: "Success",
                orderId: "ORD-2024-5792",
                paymentId: "PAY-3847-9582-1736",
              ...
              list.forEach((tx) => {
                ...
                let icon = "";
                let iconColor = "";
                if (mapPaymentType(tx.type) === "Credit Card") {
                ...
                <div class="hidden md:grid md:grid-cols-6 gap-4 p-6 items-center">
                  ...
                  <div class="font-mono text-sm text-gray-700">${tx.id}</div>
                  <div class="flex items-center gap-2">
                  <div class="w-6 h-6 flex items-center justify-center">
                    <i class="${icon} ${iconColor}"></i>
                  </div>
                  <span class="text-gray-900">${mapPaymentType(tx.type)}</span>
                  </div>
                  <div class="font-semibold text-gray-900">$${tx.amount.toFixed(2)}</div>
                  <div>
                ...
                wrapper.className = "transaction-row transition-all duration-300 cursor-pointer hover:bg-gray-100";
              ...
              if (live) {
                ...
                filterTimeout = setTimeout(() => filterTransactions(false), 200);
                return;
              }
              ...
              let filtered = transactions.filter((tx) => {
                // Date filter
                if (dateFrom) {
                const txDate = new Date(tx.date + " " + tx.time.replace("UTC", "UTC"));
                const from = new Date(dateFrom + "T00:00:00Z");
                if (txDate < from) return false;
                }
                // Payment type filter (robust)
                if (paymentType) {
                if (mapPaymentType(tx.type) !== paymentType) return false;
                }
                // Status filter
                if (status) {
            ...
            <div class="hidden md:block bg-white border-b border-gray-200">
              <div
              class="grid grid-cols-6 gap-4 p-6 text-sm font-semibold text-gray-900"
              >
              <div>Date & Time</div>
      ...
      >
        <div
          class="bg-white rounded-2xl max-w-md w-full p-6 fade-in shadow-2xl border border-gray-200"
        >
          <!-- Modal Header -->
        ...
        modalContent.innerHTML = `
                    <div class="space-y-4">
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <span class="text-gray-500 font-mono">${transaction.cardLast4}</span>
                        </div>
                        `
                            : ""
                        }
                        ...
                        <div class="flex justify-between items-start">
                            ...
                            <span class="text-gray-500 font-mono text-xs break-all text-right max-w-48">${transaction.walletAddress}</span>
                        </div>
                        `
                            : ""
                        }
